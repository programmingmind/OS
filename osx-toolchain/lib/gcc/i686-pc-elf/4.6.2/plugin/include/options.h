...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 751,             /* -m128bit-long-double */
  OPT_m32 = 752,                             /* -m32 */
  OPT_m3dnow = 753,                          /* -m3dnow */
  OPT_m3dnowa = 754,                         /* -m3dnowa */
  OPT_m64 = 755,                             /* -m64 */
  OPT_m80387 = 756,                          /* -m80387 */
  OPT_m8bit_idiv = 757,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 758,              /* -m96bit-long-double */
  OPT_mabi_ = 759,                           /* -mabi= */
  OPT_mabm = 760,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 761,       /* -maccumulate-outgoing-args */
  OPT_maes = 762,                            /* -maes */
  OPT_malign_double = 763,                   /* -malign-double */
  OPT_malign_functions_ = 764,               /* -malign-functions= */
  OPT_malign_jumps_ = 765,                   /* -malign-jumps= */
  OPT_malign_loops_ = 766,                   /* -malign-loops= */
  OPT_malign_stringops = 767,                /* -malign-stringops */
  OPT_march_ = 768,                          /* -march= */
  OPT_masm_ = 769,                           /* -masm= */
  OPT_mavx = 770,                            /* -mavx */
  OPT_mavx256_split_unaligned_load = 771,    /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 772,   /* -mavx256-split-unaligned-store */
  OPT_mbmi = 773,                            /* -mbmi */
  OPT_mbranch_cost_ = 774,                   /* -mbranch-cost= */
  OPT_mcld = 775,                            /* -mcld */
  OPT_mcmodel_ = 776,                        /* -mcmodel= */
  /* OPT_mcpu_ = 777, */                     /* -mcpu= */
  OPT_mcrc32 = 778,                          /* -mcrc32 */
  OPT_mcx16 = 779,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 780,             /* -mdispatch-scheduler */
  OPT_mf16c = 781,                           /* -mf16c */
  OPT_mfancy_math_387 = 782,                 /* -mfancy-math-387 */
  OPT_mfentry = 783,                         /* -mfentry */
  OPT_mfma = 784,                            /* -mfma */
  OPT_mfma4 = 785,                           /* -mfma4 */
  OPT_mforce_drap = 786,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 787,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 788,                        /* -mfpmath= */
  OPT_mfsgsbase = 789,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 790, */               /* -mfused-madd */
  OPT_mhard_float = 791,                     /* -mhard-float */
  OPT_mieee_fp = 792,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 793,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 794,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 795,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 796, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 797,          /* -mlarge-data-threshold= */
  OPT_mlwp = 798,                            /* -mlwp */
  OPT_mmmx = 799,                            /* -mmmx */
  OPT_mmovbe = 800,                          /* -mmovbe */
  OPT_mms_bitfields = 801,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 802,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 803,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 804,                   /* -mno-push-args */
  OPT_mno_red_zone = 805,                    /* -mno-red-zone */
  OPT_mno_sse4 = 806,                        /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 807,        /* -momit-leaf-frame-pointer */
  OPT_mpc = 808,                             /* -mpc */
  OPT_mpclmul = 809,                         /* -mpclmul */
  OPT_mpopcnt = 810,                         /* -mpopcnt */
  OPT_mprefer_avx128 = 811,                  /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 812,      /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 813,                      /* -mpush-args */
  OPT_mrdrnd = 814,                          /* -mrdrnd */
  OPT_mrecip = 815,                          /* -mrecip */
  OPT_mred_zone = 816,                       /* -mred-zone */
  OPT_mregparm_ = 817,                       /* -mregparm= */
  OPT_mrtd = 818,                            /* -mrtd */
  OPT_msahf = 819,                           /* -msahf */
  OPT_msoft_float = 820,                     /* -msoft-float */
  OPT_msse = 821,                            /* -msse */
  OPT_msse2 = 822,                           /* -msse2 */
  OPT_msse2avx = 823,                        /* -msse2avx */
  OPT_msse3 = 824,                           /* -msse3 */
  OPT_msse4 = 825,                           /* -msse4 */
  OPT_msse4_1 = 826,                         /* -msse4.1 */
  OPT_msse4_2 = 827,                         /* -msse4.2 */
  OPT_msse4a = 828,                          /* -msse4a */
  /* OPT_msse5 = 829, */                     /* -msse5 */
  OPT_msseregparm = 830,                     /* -msseregparm */
  OPT_mssse3 = 831,                          /* -mssse3 */
  OPT_mstack_arg_probe = 832,                /* -mstack-arg-probe */
  OPT_mstackrealign = 833,                   /* -mstackrealign */
  OPT_mstringop_strategy_ = 834,             /* -mstringop-strategy= */
  OPT_mtbm = 835,                            /* -mtbm */
  OPT_mtls_dialect_ = 836,                   /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 837,            /* -mtls-direct-seg-refs */
  OPT_mtune_ = 838,                          /* -mtune= */
  OPT_mveclibabi_ = 839,                     /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 840,               /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 841,                     /* -mvzeroupper */
  OPT_mxop = 842,                            /* -mxop */
  OPT_n = 843,                               /* -n */
  OPT_no_canonical_prefixes = 844,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 845,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 846,                   /* -nodefaultlibs */
  OPT_nostartfiles = 847,                    /* -nostartfiles */
  OPT_nostdinc = 848,                        /* -nostdinc */
  OPT_nostdinc__ = 849,                      /* -nostdinc++ */
  OPT_nostdlib = 850,                        /* -nostdlib */
  OPT_o = 851,                               /* -o */
  OPT_p = 852,                               /* -p */
  OPT_pass_exit_codes = 853,                 /* -pass-exit-codes */
  OPT_pedantic = 854,                        /* -pedantic */
  OPT_pedantic_errors = 855,                 /* -pedantic-errors */
  OPT_pg = 856,                              /* -pg */
  OPT_pie = 857,                             /* -pie */
  OPT_pipe = 858,                            /* -pipe */
  OPT_print_file_name_ = 859,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 860,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 861,           /* -print-multi-directory */
  OPT_print_multi_lib = 862,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 863,        /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 864,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 865,                /* -print-prog-name= */
  OPT_print_search_dirs = 866,               /* -print-search-dirs */
  OPT_print_sysroot = 867,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 868,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 869,                           /* -quiet */
  OPT_r = 870,                               /* -r */
  OPT_remap = 871,                           /* -remap */
  OPT_s = 872,                               /* -s */
  OPT_save_temps = 873,                      /* -save-temps */
  OPT_save_temps_ = 874,                     /* -save-temps= */
  OPT_shared = 875,                          /* -shared */
  OPT_shared_libgcc = 876,                   /* -shared-libgcc */
  /* OPT_specs = 877, */                     /* -specs */
  OPT_specs_ = 878,                          /* -specs= */
  OPT_static = 879,                          /* -static */
  OPT_static_libgcc = 880,                   /* -static-libgcc */
  OPT_static_libgfortran = 881,              /* -static-libgfortran */
  OPT_static_libgo = 882,                    /* -static-libgo */
  OPT_static_libstdc__ = 883,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 884, */                 /* -std=c++03 */
  OPT_std_c__0x = 885,                       /* -std=c++0x */
  OPT_std_c__98 = 886,                       /* -std=c++98 */
  OPT_std_c1x = 887,                         /* -std=c1x */
  /* OPT_std_c89 = 888, */                   /* -std=c89 */
  OPT_std_c90 = 889,                         /* -std=c90 */
  OPT_std_c99 = 890,                         /* -std=c99 */
  /* OPT_std_c9x = 891, */                   /* -std=c9x */
  OPT_std_gnu__0x = 892,                     /* -std=gnu++0x */
  OPT_std_gnu__98 = 893,                     /* -std=gnu++98 */
  OPT_std_gnu1x = 894,                       /* -std=gnu1x */
  /* OPT_std_gnu89 = 895, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 896,                       /* -std=gnu90 */
  OPT_std_gnu99 = 897,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 898, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 899, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 900,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 901, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 902, */          /* -std=iso9899:199x */
  OPT_symbolic = 903,                        /* -symbolic */
  OPT_t = 904,                               /* -t */
  OPT_time = 905,                            /* -time */
  OPT_time_ = 906,                           /* -time= */
  OPT_traditional = 907,                     /* -traditional */
  OPT_traditional_cpp = 908,                 /* -traditional-cpp */
  OPT_trigraphs = 909,                       /* -trigraphs */
  OPT_u = 910,                               /* -u */
  OPT_undef = 911,                           /* -undef */
  OPT_v = 912,                               /* -v */
  OPT_version = 913,                         /* -version */
  OPT_w = 914,                               /* -w */
  OPT_wrapper = 915,                         /* -wrapper */
  OPT_x = 916,                               /* -x */
  OPT_z = 917,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
