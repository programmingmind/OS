...
#define HAVE_zero_extendsidi2_1 1
...
#define HAVE_pro_epilogue_adjust_stack_si_add 1
#define HAVE_pro_epilogue_adjust_stack_si_sub 1
...
#define HAVE_adjust_stack_and_probesi 1
...
static inline rtx gen_pro_epilogue_adjust_stack_di_add  (rtx, rtx, rtx);
static inline rtx
gen_pro_epilogue_adjust_stack_di_add(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_pro_epilogue_adjust_stack_si_sub  (rtx, rtx, rtx);
static inline rtx gen_pro_epilogue_adjust_stack_di_sub  (rtx, rtx, rtx);
static inline rtx
gen_pro_epilogue_adjust_stack_di_sub(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_adjust_stack_and_probedi          (rtx, rtx, rtx);
static inline rtx
gen_adjust_stack_and_probedi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_strlendi                          (rtx, rtx, rtx, rtx);
static inline rtx
gen_strlendi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
